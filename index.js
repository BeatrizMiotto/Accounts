...
function buildAccount(){
    inquirer.prompt([
        {
            name: 'accountName',
            massage: 'Digite um nome para a sua conta:',
        },
    ])
    .then(answer => {
...
function withdraw(){
    ...
    .then((answer) =>{
        ...
        inquirer.prompt([
            {
                name: 'amount',
                messsage: 'Quanto você deseja sacar?'
            }
        ])
        .then((answer) => {
            const amount = answer['amount']
...
function removeAmount(accountName, amount){
    ...
    console.log(chalk.green(`${accountName}, foi realizado um saque de R$${amount} da sua conta!`))
    operation()
}